...
-- Passwords:
-- Manager (Rita/Ray): "SoberBoba2026!"
-- Staff (Tom-Maria): "Staff2026!"
...
VALUES
  -- Manager: Rita (ray@soberboba.com)
  ('a0000000-0000-0000-0000-000000000001', 'ray@soberboba.com', '$2b$10$szRPIsi7iK.RTL7z9f959.AJLQYUPOSwxBMz/cQbeqMiqadJJNL0G', now(), 'authenticated', 'authenticated', '{"provider":"email","providers":["email"]}', '{}', now(), now()),

  -- Staff: Tom
  ('a0000000-0000-0000-0000-000000000002', 'tom@soberboba.com', '$2b$10$1hHRm9aKc0LLWufZGYljkehO4cGaSJ8w/1VQqMS7.8CwB180QPY9G', now(), 'authenticated', 'authenticated', '{"provider":"email","providers":["email"]}', '{}', now(), now()),

  -- Staff: Emma
  ('a0000000-0000-0000-0000-000000000003', 'emma@soberboba.com', '$2b$10$1hHRm9aKc0LLWufZGYljkehO4cGaSJ8w/1VQqMS7.8CwB180QPY9G', now(), 'authenticated', 'authenticated', '{"provider":"email","providers":["email"]}', '{}', now(), now()),

  -- Staff: Sarah
  ('a0000000-0000-0000-0000-000000000004', 'sarah@soberboba.com', '$2b$10$1hHRm9aKc0LLWufZGYljkehO4cGaSJ8w/1VQqMS7.8CwB180QPY9G', now(), 'authenticated', 'authenticated', '{"provider":"email","providers":["email"]}', '{}', now(), now()),

  -- Staff: Alex
  ('a0000000-0000-0000-0000-000000000005', 'alex@soberboba.com', '$2b$10$1hHRm9aKc0LLWufZGYljkehO4cGaSJ8w/1VQqMS7.8CwB180QPY9G', now(), 'authenticated', 'authenticated', '{"provider":"email","providers":["email"]}', '{}', now(), now()),

  -- Staff: Lisa
  ('a0000000-0000-0000-0000-000000000006', 'lisa@soberboba.com', '$2b$10$1hHRm9aKc0LLWufZGYljkehO4cGaSJ8w/1VQqMS7.8CwB180QPY9G', now(), 'authenticated', 'authenticated', '{"provider":"email","providers":["email"]}', '{}', now(), now()),

  -- Staff: Maria
  ('a0000000-0000-0000-0000-000000000007', 'maria@soberboba.com', '$2b$10$1hHRm9aKc0LLWufZGYljkehO4cGaSJ8w/1VQqMS7.8CwB180QPY9G', now(), 'authenticated', 'authenticated', '{"provider":"email","providers":["email"]}', '{}', now(), now())

ON CONFLICT (id) DO NOTHING; -- Skip if already exists to avoid errors on re-run

-- ── 1. Manager User (Public Profile) ──────────────────────────
INSERT INTO public.users (id, email, password_hash, role, name) VALUES
  ('a0000000-0000-0000-0000-000000000001',
   'ray@soberboba.com',
   '$2b$10$szRPIsi7iK.RTL7z9f959.AJLQYUPOSwxBMz/cQbeqMiqadJJNL0G',
   'manager',
   'Rita')
...
INSERT INTO public.users (id, email, password_hash, role, name) VALUES
  ('a0000000-0000-0000-0000-000000000002', 'tom@soberboba.com',   '$2b$10$1hHRm9aKc0LLWufZGYljkehO4cGaSJ8w/1VQqMS7.8CwB180QPY9G', 'staff', 'Tom'),
  ('a0000000-0000-0000-0000-000000000003', 'emma@soberboba.com',  '$2b$10$1hHRm9aKc0LLWufZGYljkehO4cGaSJ8w/1VQqMS7.8CwB180QPY9G', 'staff', 'Emma'),
  ('a0000000-0000-0000-0000-000000000004', 'sarah@soberboba.com', '$2b$10$1hHRm9aKc0LLWufZGYljkehO4cGaSJ8w/1VQqMS7.8CwB180QPY9G', 'staff', 'Sarah'),
  ('a0000000-0000-0000-0000-000000000005', 'alex@soberboba.com',  '$2b$10$1hHRm9aKc0LLWufZGYljkehO4cGaSJ8w/1VQqMS7.8CwB180QPY9G', 'staff', 'Alex'),
  ('a0000000-0000-0000-0000-000000000006', 'lisa@soberboba.com',  '$2b$10$1hHRm9aKc0LLWufZGYljkehO4cGaSJ8w/1VQqMS7.8CwB180QPY9G', 'staff', 'Lisa'),
  ('a0000000-0000-0000-0000-000000000007', 'maria@soberboba.com', '$2b$10$1hHRm9aKc0LLWufZGYljkehO4cGaSJ8w/1VQqMS7.8CwB180QPY9G', 'staff', 'Maria')
ON CONFLICT (id) DO NOTHING;
